		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="row search-header">
				<div class="col-md-9 col-sm-10 col-xs-6">
					<h2> <span class="bold"> {{$sub_category->sub_category}} </span> Category</h2>
				</div>
		...
		<div class="col-md-8 col-sm-8 col-xs-12 search-left-side">
			...
			<div class="row search-result {{($business->featured_ad_expiry!='0000-00-00')?'featured':''}}">
				<a href="{{URL::route('viewPublicProfile',array('id'=>$business->reviews[0]->user->id))}}">
					...
					<div class="col-md-1 col-xs-2 search-result-review"><img src="{{ asset(Image::path('/uploads/'.$image , 'resizeCrop', 32, 32) )}}" title="{{$business->reviews[0]->user->first_name}} {{$business->reviews[0]->user->last_name}}"></div>
				</a>
